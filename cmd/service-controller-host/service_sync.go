...
func (c *Controller) runServiceSync() error {
	...
	client, err := amqp.Dial("amqp://127.0.0.1:5672", amqp.ConnMaxFrameSize(4294967295))
//	client, err := amqp.Dial("amqps://192.168.1.24:5671", amqp.ConnSASLExternal(), amqp.ConnMaxFrameSize(4294967295), amqp.ConnTLSConfig(c.tlsConfig))
