...
func (cli *containerClient) GetRouterSpecFromOpts(options types.SiteConfigSpec, siteId string) (*types.RouterSpec, error) {
...
func (cli *containerClient) RouterCreate(options types.SiteConfigSpec) error {
