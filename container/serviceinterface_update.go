...
func getServiceInterfaceTarget(targetType string, targetName string, deducePort bool, cli *containerClient) (*types.ServiceInterfaceTarget, error) {
...
func updateServiceInterface(service *types.ServiceInterface, overwriteIfExists bool, cli *containerClient) error {
...
func (cli *containerClient) ServiceInterfaceUpdate(ctx context.Context, service *types.ServiceInterface) error {
...
func (cli *containerClient) ServiceInterfaceBind(service *types.ServiceInterface, targetType string, targetName string, protocol string, targetPort int) error {
	sc, err := cli.SiteConfigInspect(types.DefaultBridgeName)
	if err != nil {
		return fmt.Errorf("Unable to retrieve site config: %w", err)
	}
...
func removeServiceInterfaceTarget(serviceName string, targetName string, deleteIfNoTargets bool, cli *containerClient) error {
	sc, err := cli.SiteConfigInspect(types.DefaultBridgeName)
	if err != nil {
		return fmt.Errorf("Unable to retrieve site config: %w", err)
	}
...
func (cli *containerClient) ServiceInterfaceUnbind(targetType string, targetName string, address string, deleteIfNoTargets bool) error {
	sc, err := cli.SiteConfigInspect(types.DefaultBridgeName)
	if err != nil {
		return fmt.Errorf("Unable to retrieve site config: %w", err)
	}
