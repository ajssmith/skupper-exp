...
p	ctx, cancel := getCancelableContext()
	defer cancel()
...
func (c *dockerClient) ContainerList(opts driver.ContainerListOptions) ([]driver.Container, error) {
...
func (c *dockerClient) NetworkInspect(id string) (driver.NetworkResource, error) {
	var netResource driver.NetworkResource
